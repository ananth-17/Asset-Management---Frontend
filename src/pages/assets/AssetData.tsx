        ...
        <div className="flex justify-between px-4 mt-2 my-6 py-1">
          ...
          <div className="inline-flex items-center justify-center rounded-md border border-slate-300 bg-gray-2 hover:bg-primary hover:text-white">
            <button
              ...
              onClick={() => {navigate('/home/assets/add', { state: { editData: null, editMode: false}})}}
            >
                ...
                >
                  ...
                  <td className={`py-3 pl-7 pr-1 text-base font-normal whitespace-nowrap`}>
                    <div className="flex flex-row gap-4">
                      <button className="group relative" onClick={() => props.downloadQR(data.id)}>
                      <span className="absolute -left-5 bottom-5 scale-0 transition-all rounded bg-black p-1 text-xs text-white group-hover:scale-100">Download QR</span>
                      ...
                      <button className="group relative" onClick={()=> navigate("/home/assets/add", { state: { editData:data, editMode: true}})}>
